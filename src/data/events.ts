...
export const EVENT_CARDS: EventCard[] = [
  ...
  // --- 日本成長戦略関連イベント ---
  {
    id: 'breakthrough_quantum',
    title: '量子コンピュータ実用化',
    description: '国産量子コンピュータが世界最高水準の性能を達成。量子・AI系DeepTechに大きな追い風。',
    category: 'breakthrough',
    effects: [{ target: 'deeptech', growthModifier: +2 }],
  },
  {
    id: 'bubble_space',
    title: '宇宙ビジネス解禁',
    description: '宇宙資源開発・衛星コンステレーション事業が民間に全面開放。DeepTech投資が沸騰。',
    category: 'bubble',
    effects: [{ target: 'deeptech', growthModifier: +2, valuationModifier: 1.4 }],
  },
  {
    id: 'breakthrough_gx',
    title: 'GX推進予算拡大',
    description: '政府が数兆円規模のGX移行債を発行。CleanTechスタートアップへの補助金・需要が急増。',
    category: 'breakthrough',
    effects: [{ target: 'cleantech', growthModifier: +2 }],
  },
  {
    id: 'bubble_semiconductor',
    title: '半導体国産化政策',
    description: '経済安全保障法に基づく半導体国産化プロジェクトが本格始動。大型補助金でDeepTechに追い風。',
    category: 'bubble',
    effects: [{ target: 'deeptech', growthModifier: +1, valuationModifier: 1.3 }],
  },
  {
    id: 'breakthrough_foodtech',
    title: 'フードテック振興策',
    description: '農水省主導のフードテック官民協議会が規制緩和を実現。代替食品・精密発酵市場が開花。',
    category: 'breakthrough',
    effects: [{ target: 'consumer', growthModifier: +2 }],
  },
  {
    id: 'regulation_cyber',
    title: '大規模サイバー攻撃',
    description: '政府・重要インフラへのサイバー攻撃が発生し規制強化が議論に。SaaSの調達審査が厳格化。',
    category: 'regulation',
    effects: [{ target: 'saas', growthModifier: -2 }],
  },
  {
    ...
    title: '先端技術輸出規制',
    description: '量子・AI・半導体分野の輸出管理規制が強化。海外展開中のDeepTechに逆風。',
    category: 'regulation',
    effects: [{ target: 'deeptech', growthModifier: -1 }],
  },
  {
    id: 'breakthrough_startup_policy',
    title: 'スタートアップ育成5カ年計画',
    description: '政府がスタートアップ支援に1兆円規模の予算を投入。エコシステム全体が活性化しExit環境も改善。',
    category: 'breakthrough',
    effects: [{ target: 'all', growthModifier: +1, exitModifier: +1 }],
  },
  {
    id: 'breakthrough_bioeconomy',
    title: 'バイオエコノミー戦略始動',
    description: '合成生物学・ゲノム編集の産業応用に向けた規制緩和パッケージが閣議決定。HealthTechに革命的追い風。',
    category: 'breakthrough',
    effects: [{ target: 'healthtech', growthModifier: +2 }],
  },
  {
    id: 'breakthrough_ocean',
    title: '海洋資源開発成功',
    description: '深海レアアース採掘・洋上風力の大規模実証実験が成功。資源安全保障への貢献でCleanTech評価急騰。',
    category: 'breakthrough',
    effects: [{ target: 'cleantech', growthModifier: +2 }],
  },
];
